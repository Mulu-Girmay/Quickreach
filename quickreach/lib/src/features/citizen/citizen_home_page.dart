...
import '../citizen/citizen_cubit.dart';
import '../citizen/citizen_state.dart';
                ...
                .map(
                  (type) => ChoiceChip(
                    ...
                    labelStyle: TextStyle(
                      color: state.selectedType == type ? Colors.white : Colors.white70,
                      fontWeight: FontWeight.w700,
                    ),
                    onSelected: (_) => context.read<CitizenCubit>().setSelectedType(type),
                  ),
                )
                .toList(),
          ),
          ...
          Row(
            children: [
              _Pill(
                ...
                color: state.locationReady ? Colors.greenAccent : Colors.orangeAccent,
              ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _Pill(label: incident.syncStatus.toUpperCase(), color: Colors.white70),
              const SizedBox(width: 10),
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  incident.syncStatus == "sent" ? "Sent to dispatch" : incident.status,
      ...
      child: Column(
        ...
        children: [
          ...
          if (state.offlineIncidents.isEmpty)
            ...
            ...state.offlineIncidents.take(3).map(
              (incident) => Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          if (state.cachedIncidents.isEmpty)
            ...
            ...state.cachedIncidents.take(5).map(
              (incident) => Padding(
                padding: const EdgeInsets.only(bottom: 10),
                child: _CachedTile(incident: incident, formatDate: formatDate),
              ),
            ),
        ],
      ),
