  ...
  return (
    <div className="emergency-shell-light min-h-screen w-full bg-gradient-to-b from-slate-50 via-slate-50 to-slate-100/70 font-sans text-slate-900 selection:bg-red-100 selection:text-red-900">
      ...
      {activeTab === "roles" && (
        <main
          id="roles"
          className="w-full max-w-6xl mx-auto px-4 sm:px-6 -mt-16 relative z-20 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-500"
        >
          ...
          {/* Stats / Trust Section */}
          <div className="max-w-4xl mx-auto mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-slate-200 pt-12">
