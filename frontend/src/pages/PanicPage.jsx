...
import { ShieldAlert, Phone, Navigation, Info, Video, Heart, CheckCircle, MessageCircle } from 'lucide-react';
          ...
          <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-600 leading-relaxed mt-1">
                Stay calm. If possible, remain in your current location. Dispatchers may attempt to call you for more details.
              </p>
              <button
