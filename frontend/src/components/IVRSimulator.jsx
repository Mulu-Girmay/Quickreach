      ...
      <div className="bg-slate-900 border border-white/10 w-full max-w-sm rounded-[3rem] overflow-hidden shadow-2xl relative">
        ...
        <div className="p-10 pt-20 text-center">
          ...
          <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest mb-8">
            Language: {lang ? lang.toUpperCase() : "PENDING"}
          </p>

          {!isCalling ? (
            <button
              onClick={startCall}
              className="w-full bg-red-600 hover:bg-red-500 text-white py-4 rounded-2xl font-black transition-all flex items-center justify-center gap-3"
            >
